...
namespace Cwiczenia11.Migrations
{
    ...
    [Migration("20200522140407_SeedDatabase")]
            ...
            modelBuilder.Entity("Cwiczenia11.Models.Medicament", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdMedicament = 1,
                            Description = "Xanax działa uspokajająco, przeciwdrgawkowo i nasennie, wycisza i może powodować zobojętnienie.",
                            Name = "Xanax",
                            Type = "Antydepresant"
                        });
                });
            ...
            modelBuilder.Entity("Cwiczenia11.Models.Prescription", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DueDate = new DateTime(2020, 1, 3, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            IdDoctor = 1,
                            IdPatient = 1
                        });
                });
            ...
            modelBuilder.Entity("Cwiczenia11.Models.Prescription_Medicament", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            IdPrescription = 1,
                            IdMedicament = 1,
                            Details = "Używać w razie napadów lęku",
                            Dose = 0
                        });
                });
